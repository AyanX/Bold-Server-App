...
const DashboardSettings: React.FC<DashboardSettingsProps> = ({
  ...
  const allowedTabs = isAdmin ? ALL_TABS : (["profile", "security"] as const);

  type SettingsTab = (typeof allowedTabs)[number];

  // the default starting tab based on role when you navigate to settings
  const startingTab: SettingsTab = isAdmin ? "general" : "profile";

  const [settingsTab, setSettingsTab] = useState<SettingsTab>(startingTab);
  ...
  const [seoSettings, setSeoSettings] = useState({
    ...
    meta_description:
      "Stay informed with the latest news, analysis, and insights from East Africa.",
    ...
    const fetchSettings = async () => {
      try {
        ...
        if (res.data && Array.isArray(res.data)) {
          ...
          if (groupedSettings.seo)
            setSeoSettings((prev) => ({ ...prev, ...groupedSettings.seo }));
          if (groupedSettings.content)
  ...
  const Toggle = ({
    ...
    <div className="flex items-center justify-between py-4 border-b border-gray-50 last:border-0">
      ...
      <button
        ...
        className={`w-12 h-6 rounded-full relative transition-all duration-200 ${value ? "bg-[#e5002b]" : "bg-gray-200"}`}
      >
        <span
          className={`absolute top-1 w-4 h-4 rounded-full bg-white shadow-sm transition-all duration-200 ${value ? "left-7" : "left-1"}`}
        ></span>
      </button>
    </div>
  );
  ...
  const InputField = ({
    ...
    <div>
      ...
      <input
        ...
        className="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#001733] focus:ring-2 focus:ring-[#001733]/10 rounded-lg transition-all"
      />
      {description && (
  ...
  const SelectField = ({
    ...
    <div>
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#001733] focus:ring-2 focus:ring-[#001733]/10 rounded-lg bg-white transition-all"
      >
        {options.map((opt) => (
  ...
  const SaveButton = ({
    ...
    <button
      onClick={onClick}
      disabled={loading}
      className="bg-[#e5002b] text-white px-8 py-3 text-xs font-bold uppercase tracking-widest hover:bg-[#001733] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg shadow-lg shadow-[#e5002b]/20 hover:shadow-[#001733]/20"
    >
      {loading ? (
  ...
  const MetricCard = ({
    ...
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all group">
      <div className="flex justify-between items-start mb-4">
        ...
        {change && (
          <span
            className={`text-xs font-bold px-2 py-1 rounded-full ${trend === "up" ? "bg-green-50 text-green-600" : trend === "down" ? "bg-red-50 text-red-600" : "bg-gray-50 text-gray-600"}`}
          >
            {trend === "up" && "+"}
            {change}
          </span>
      ...
      <h3 className="text-3xl font-black text-[#001733] mb-1">
  ...
  return (
    <div className="flex gap-8 animate-in fade-in duration-300">
      ...
      <div className="flex-1 space-y-6">
          ...
          <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <InputField
                ...
                onChange={(v) =>
                  setSiteSettings({ ...siteSettings, site_name: v })
                }
              />
              <InputField
                label="Site Tagline"
                ...
                onChange={(v) =>
                  setSiteSettings({ ...siteSettings, site_tagline: v })
                }
              />
              ...
              <InputField
                ...
                onChange={(v) =>
                  setSiteSettings({ ...siteSettings, contact_email: v })
                }
                type="email"
              />
              <InputField
                ...
                onChange={(v) =>
                  setSiteSettings({ ...siteSettings, contact_phone: v })
                }
              />
              <SelectField
                label="Timezone"
              ...
              <SelectField
                label="Date Format"
                value={siteSettings.date_format}
                onChange={(v) =>
                  setSiteSettings({ ...siteSettings, date_format: v })
                }
                options={[
            ...
            <div className="flex justify-end mt-8 pt-6 border-t border-gray-100">
              <SaveButton
                onClick={() =>
                  handleSaveSettings(siteSettings, "General settings saved!")
                }
        ...
        {/* Appearance Settings */}
        {settingsTab === "appearance" && isAdmin && (
          <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
            <SectionHeader
            ...
            <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      className="w-14 h-11 border border-gray-200 rounded-lg cursor-pointer"
                    />
                    <input
                      type="text"
                      value={appearanceSettings.primary_color}
                      ...
                      className="flex-1 border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#001733] rounded-lg"
                    />
                  </div>
                </div>
                <div>
              ...
              <div className="pt-6 border-t border-gray-100">
                <h4 className="text-sm font-bold text-[#001733] mb-4">
                  Display Options
                </h4>
                <Toggle
                  label="Collapse Sidebar by Default"
                  description="Start with a minimized sidebar"
                  value={appearanceSettings.sidebar_collapsed}
                  onChange={(v) =>
                    setAppearanceSettings({
                      ...appearanceSettings,
                      sidebar_collapsed: v,
                ...
                <Toggle
                  ...
                  value={appearanceSettings.show_animations}
                  onChange={(v) =>
                    setAppearanceSettings({
                      ...appearanceSettings,
                      show_animations: v,
        ...
        {settingsTab === "notifications" && isAdmin && (
          <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
            <SectionHeader
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <Toggle
                    ...
                    description="Get a weekly digest of your site's performance"
                    value={notificationSettings.weekly_report}
                    onChange={(v) =>
                      setNotificationSettings({
                        ...notificationSettings,
                        weekly_report: v,
              ...
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <Toggle
                    ...
                    description="Be notified when articles are published"
                    value={notificationSettings.new_article_alerts}
                    onChange={(v) =>
                      setNotificationSettings({
                        ...notificationSettings,
                        new_article_alerts: v,
                      })
                    }
                  />
                  <Toggle
            ...
            <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
              ...
              <div className="space-y-4 max-w-md">
                <InputField
                  ...
                  onChange={(v) =>
                    setProfileData({ ...profileData, currentPassword: v })
                  }
                  type="password"
                ...
                <InputField
                  ...
                  onChange={(v) =>
                    setProfileData({ ...profileData, newPassword: v })
                  }
                  type="password"
                ...
                <InputField
                  ...
                  onChange={(v) =>
                    setProfileData({ ...profileData, confirmPassword: v })
                  }
                  type="password"
              ...
              <div className="flex justify-start mt-6">
                <button
                  ...
                  className="bg-[#001733] text-white px-6 py-3 text-xs font-bold uppercase tracking-widest hover:bg-black transition-colors disabled:opacity-50 rounded-lg"
                >
            ...
            <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
              ...
              <div className="space-y-4">
                <Toggle
                  ...
                  value={securitySettings.two_factor_enabled}
                  onChange={(v) =>
                    setSecuritySettings({
                      ...securitySettings,
                ...
                <Toggle
                  ...
                  value={securitySettings.require_strong_password}
                  onChange={(v) =>
                    setSecuritySettings({
                      ...securitySettings,
                      require_strong_password: v,
                    })
                  }
                />
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#001733] rounded-lg"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">
          ...
          <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
            ...
            <div className="space-y-6">
              <InputField
                ...
                onChange={(v) =>
                  setSeoSettings({ ...seoSettings, meta_title: v })
                }
              ...
              <InputField
                ...
                onChange={(v) =>
                  setSeoSettings({ ...seoSettings, meta_keywords: v })
                }
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <InputField
                    ...
                    onChange={(v) =>
                      setSeoSettings({ ...seoSettings, twitter_handle: v })
                    }
                    placeholder="@yourhandle"
                  />
                  <InputField
                    label="Facebook Page URL"
                    value={seoSettings.facebook_url}
                    onChange={(v) =>
                      setSeoSettings({ ...seoSettings, facebook_url: v })
                    }
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                <InputField
                  ...
                  onChange={(v) =>
                    setSeoSettings({ ...seoSettings, google_analytics_id: v })
                  }
                  placeholder="G-XXXXXXXXXX"
                  description="Enter your Google Analytics 4 measurement ID"
                />
              </div>
            </div>
            <div className="flex justify-end mt-8 pt-6 border-t border-gray-100">
              <SaveButton
                onClick={() =>
                  handleSaveSettings(seoSettings, "SEO settings saved!")
                }
                loading={settingsLoading}
              />
            </div>
        ...
        {/* Content Settings */}
        {settingsTab === "content" && isAdmin && (
          <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
            <SectionHeader
              title="Content Settings"
              description="Configure how content is created and displayed."
            />
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <SelectField
                  label="Default Article Status"
                  value={contentSettings.default_article_status}
                  onChange={(v) =>
                    setContentSettings({
                      ...contentSettings,
                      default_article_status: v,
                    })
                  }
                  options={[
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={contentSettings.auto_save_interval}
                    onChange={(e) =>
                      setContentSettings({
                        ...contentSettings,
                ...
                <div>
                  ...
                  <input
                    type="number"
                    value={contentSettings.articles_per_page}
                    onChange={(e) =>
                      setContentSettings({
                        ...contentSettings,
                        articles_per_page: parseInt(e.target.value) || 10,
                      })
                    }
                    className="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#001733] rounded-lg"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContentSettings({
                        ...contentSettings,
                        excerpt_length: parseInt(e.target.value) || 150,
                      })
                    }
                    className="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#001733] rounded-lg"
                  />
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                <Toggle
                  ...
                  description="Articles must have a featured image to publish"
                  value={contentSettings.require_featured_image}
                  onChange={(v) =>
                    setContentSettings({
                      ...contentSettings,
                      require_featured_image: v,
                    })
                  }
                />
                <Toggle
                  ...
                  value={contentSettings.enable_comments}
                  onChange={(v) =>
                    setContentSettings({
                      ...contentSettings,
                      enable_comments: v,
                ...
                <Toggle
                  ...
                  value={contentSettings.moderate_comments}
                  onChange={(v) =>
                    setContentSettings({
                      ...contentSettings,
                      moderate_comments: v,
            ...
            <div className="flex justify-end mt-8 pt-6 border-t border-gray-100">
              <SaveButton
                onClick={() =>
                  handleSaveSettings(contentSettings, "Content settings saved!")
                }
                loading={settingsLoading}
              />
            </div>
        ...
        {/* Performance Metrics */}
        {settingsTab === "performance" && isAdmin && (
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-[#001733] to-[#002855] p-8 rounded-xl text-white">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-white/60 text-sm mt-1">
                    Monitor your site's performance and growth
                  </p>
                </div>
                <button
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="bg-white/10 rounded-xl p-4">
                    <p className="text-3xl font-black">
                      {performanceMetrics.overview.total_page_views.toLocaleString()}
                    </p>
                  ...
                  <div className="bg-white/10 rounded-xl p-4">
                    <p className="text-3xl font-black">
                      {performanceMetrics.overview.today_views.toLocaleString()}
                    </p>
                    <p className="text-xs text-white/60 uppercase tracking-widest mt-1">
                      Today's Views
                    </p>
                    {performanceMetrics.overview.daily_growth !== 0 && (
                      <span
                        className={`text-xs font-bold ${performanceMetrics.overview.daily_growth > 0 ? "text-green-400" : "text-red-400"}`}
                      >
                        {performanceMetrics.overview.daily_growth > 0
                          ? "+"
                          : ""}
                        {performanceMetrics.overview.daily_growth}%
                      </span>
                    )}
                  </div>
                  <div className="bg-white/10 rounded-xl p-4">
                    <p className="text-3xl font-black">
                      {performanceMetrics.overview.this_week_views.toLocaleString()}
                    </p>
                    <p className="text-xs text-white/60 uppercase tracking-widest mt-1">
                      This Week
                    </p>
                    {performanceMetrics.overview.weekly_growth !== 0 && (
                      <span
                        className={`text-xs font-bold ${performanceMetrics.overview.weekly_growth > 0 ? "text-green-400" : "text-red-400"}`}
                      >
                        {performanceMetrics.overview.weekly_growth > 0
                          ? "+"
                          : ""}
                        {performanceMetrics.overview.weekly_growth}%
                      </span>
                    )}
                  </div>
                  <div className="bg-white/10 rounded-xl p-4">
                    <p className="text-3xl font-black">
                      {performanceMetrics.overview.this_month_views.toLocaleString()}
                    </p>
                    <p className="text-xs text-white/60 uppercase tracking-widest mt-1">
                      This Month
                    </p>
                    {performanceMetrics.overview.monthly_growth !== 0 && (
                      <span
                        className={`text-xs font-bold ${performanceMetrics.overview.monthly_growth > 0 ? "text-green-400" : "text-red-400"}`}
                      >
                        {performanceMetrics.overview.monthly_growth > 0
                          ? "+"
                          : ""}
                        {performanceMetrics.overview.monthly_growth}%
                      </span>
                    )}
                  </div>
                </div>
            ...
            {performanceMetrics && (
              <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
                <h4 className="text-lg font-bold text-[#001733] mb-6">
                  Views - Last 7 Days
                </h4>
                <div className="h-48 flex items-end gap-2">
                  {performanceMetrics.charts.views_by_day.map((day, index) => {
                    const maxViews = Math.max(
                      ...performanceMetrics.charts.views_by_day.map(
                        (d) => d.views,
                      ),
                      1,
                    );
                    ...
                    return (
                      ...
                      >
                        <div
                          className="w-full bg-gray-100 rounded-t-lg relative group"
                          style={{ height: "160px" }}
                        >
                          <div
                ...
                <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      ...
                      <span className="text-2xl font-black text-[#001733]">
                        {performanceMetrics.articles.total}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                      ...
                      <span className="text-2xl font-black text-green-600">
                        {performanceMetrics.articles.published}
                      </span>
                    </div>
                    <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
                      ...
                      <span className="text-2xl font-black text-yellow-600">
                        {performanceMetrics.articles.drafts}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
                  ...
                  <div className="space-y-3">
                    {performanceMetrics.articles.top_performing.length > 0 ? (
                      performanceMetrics.articles.top_performing.map(
                        (article, index) => (
                          <div
                            key={article.id}
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-medium text-[#001733] truncate">
                                {article.title}
                              </p>
            ...
            {performanceMetrics &&
              performanceMetrics.charts.category_performance.length > 0 && (
                <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
                  <h4 className="text-lg font-bold text-[#001733] mb-6">
                    Category Performance
                  </h4>
                  <div className="space-y-4">
                    {performanceMetrics.charts.category_performance.map(
                      (cat, index) => {
                        const maxViews = Math.max(
                          ...performanceMetrics.charts.category_performance.map(
                            (c) => c.total_views || 0,
                          ...
                          <div key={index} className="space-y-2">
                            <div className="flex items-center justify-between">
                              ...
                              <span className="text-sm text-gray-400">
                                {cat.count} articles •{" "}
                                {(cat.total_views || 0).toLocaleString()} views
                              </span>
                            </div>
                            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                              <div
                                className="h-full bg-gradient-to-r from-[#001733] to-[#e5002b] rounded-full transition-all duration-500"
                                style={{ width: `${width}%` }}
                              ></div>
                            </div>
                          </div>
        ...
        {settingsTab === "data" && isAdmin && (
          <div className="space-y-6">
            {/* System Stats */}
            <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
              <SectionHeader
                title="System Information"
                description="View current system statistics and resource usage."
              />
              {systemStats ? (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <MetricCard
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                  <div className="p-4 bg-blue-50 rounded-xl">
                    <p className="text-lg font-black text-blue-700">
                      {systemStats.system?.database_size || "N/A"}
                    </p>
                  ...
                  <div className="p-4 bg-green-50 rounded-xl">
                    <p className="text-lg font-black text-green-700">
                      Node{" "}
                      {systemStats?.system?.node_version
                        ?.substring(1)
                        ?.split("-")[0] || "N/A"}
                    </p>
                  ...
                  <div className="p-4 bg-purple-50 rounded-xl">
                    <p className="text-lg font-black text-purple-700">
                      Express {systemStats.system?.express_version || "N/A"}
                    </p>
                  ...
                  <div className="p-4 bg-orange-50 rounded-xl">
                    <p className="text-lg font-black text-orange-700">
                      {systemStats.system?.timezone || "N/A"}
                    </p>
            ...
            <div className="bg-white p-8 border border-gray-100 shadow-sm rounded-xl">
              <SectionHeader
                ...
                description="Export, backup, and manage your site data."
              />
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button
                  onClick={handleExportData}
                  className="p-6 border-2 border-dashed border-gray-200 rounded-xl hover:border-[#001733] hover:bg-gray-50 transition-all group text-left"
                >
                  <svg
                    className="w-10 h-10 text-gray-300 group-hover:text-[#001733] mb-4 transition-colors"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <button
                  ...
                  className="p-6 border-2 border-dashed border-gray-200 rounded-xl hover:border-orange-500 hover:bg-orange-50 transition-all group text-left"
                >
                  <svg
                    className="w-10 h-10 text-gray-300 group-hover:text-orange-500 mb-4 transition-colors"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
            ...
            <div className="bg-white p-8 border border-red-100 shadow-sm rounded-xl">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                  ...
                  className="px-6 py-3 border-2 border-red-200 text-red-600 text-xs font-bold uppercase tracking-widest hover:bg-red-50 transition-colors rounded-lg"
                >
                  Reset All Settings
                </button>
              </div>
